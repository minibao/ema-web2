...
module.exports = {
    ...
    //英灵--获取区服
    getServerDictionaryData: function (params, callback) {
        request({
            url: '/bi/emaGameData/yingling/getServerDictionaryData',
            method: 'POST',
            form: params
        }, function (err, res, body) {
            callback(err, body);
    ...
    //英灵--查询英灵用户数据
    getUserDataYingling: function (params, callback) {
        request({
            url: '/bi/emaGameData/yingling/getUserDataList',
            method: 'POST',
            form: params
        }, function (err, res, body) {
            callback(err, body);
    ...
    //英灵--查询用户游戏中的基本数据
    getUserGameDataYingling: function (params, callback) {
        request({
            url: '/bi/emaGameData/yingling/getUserGameData',
            method: 'POST',
            form: params
        }, function (err, res, body) {
            callback(err, body);
    ...
    //英灵--查询用户英雄的卡组数据
    getUserFavorGroupCardData: function (params, callback) {
        request({
            url: '/bi/emaGameData/yingling/getUserFavorGroupCardData',
            method: 'POST',
            form: params
        }, function (err, res, body) {
            callback(err, body);
