...
//英灵--获取区服
router.post('/getServerDictionaryData', function (req, res) {
    store.getServerDictionaryData({
    }, function (err, result) {
        util.commonAjaxReturn(res, err, result);
    })
});
...
//英灵--查询英灵用户数据
router.post('/getUserDataYingling', function (req, res) {
    store.getUserDataYingling({
        platformId: req.body.uid,
        server: req.body.server
    }, function (err, result) {
        util.commonAjaxReturn(res, err, result);
    })
...
//英灵--查询用户游戏中的基本数据
router.post('/getUserGameDataYingling', function (req, res) {
    store.getUserGameDataYingling({
        uid: req.body.uid,
        server: req.body.server
    }, function (err, result) {
        util.commonAjaxReturn(res, err, result);
...
//英灵--查询用户英雄的卡组数据
router.post('/getUserFavorGroupCardData', function (req, res) {
    store.getUserFavorGroupCardData({
        uid: req.body.uid,
        server: req.body.server,
